...
RENDERER_WORKERS="${RENDERER_WORKERS:-1}"
...
write_distribution_sample() {
    ...
    printf '%s\n' \
        ...
        "sophia_live_native_resources schema=10 status=complete renderer_workers=$RENDERER_WORKERS worker_result_misroutes=0 worker_max_service_skew=0" \

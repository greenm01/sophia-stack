...

{
    ...
    echo 'sophia_live_session_control schema=2 status=complete enqueued=9 dispatched=9 delivered=8 stale_retired=1 rejected=0 timed_out=0 unexpected=0 pending=0 peak_depth=2 max_queue_dwell_msec=2 max_ack_msec=80'

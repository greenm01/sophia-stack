...
printf '%s\n' \
    'sophia_policy_behavior_corpus schema=3 status=complete revision=2 clients=rust,c scenarios=11 sequential=true action=true timeout_recovery=true stale_recovery=true invalid_recovery=true'

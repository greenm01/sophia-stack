...
grep -Eq '^sophia_live_session schema=(14|15) status=bounded_complete .*cpu_layers=[2-9][0-9]* .*wm_policy=external .*wm_requests=[1-9][0-9]* .*wm_committed=[1-9][0-9]* .*wm_degraded=false ' "$evidence"

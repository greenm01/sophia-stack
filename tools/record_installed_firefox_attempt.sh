...
SOPHIA_ATTEMPT_KIND=firefox
SOPHIA_ATTEMPT_PROFILE=hagia
SOPHIA_ATTEMPT_RESULT_RECORD=sophia_installed_firefox
SOPHIA_ATTEMPT_RUN_ROOT="${SOPHIA_FIREFOX_RUN_ROOT:-$STATE_HOME/sophia/promotion/firefox-runs}"
...
SOPHIA_ATTEMPT_VERIFY_SESSION="${SOPHIA_VERIFY_FIREFOX_BIN:-$RELEASE_DIR/bin/sophia-verify-firefox-run}"
...
if [[ ! -x "$SOPHIA_ATTEMPT_VERIFY_SESSION" ]]; then
    SOPHIA_ATTEMPT_VERIFY_SESSION="$RELEASE_DIR/tools/verify_sophia_firefox_physical.sh"
fi

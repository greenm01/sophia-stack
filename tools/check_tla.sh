...
for model in VisualRetirement AdmissionRecovery PresentFrameOwnership PresentCopyOwnership SurfaceContentStream GeometryFeedback PolicyConnection PolicyProjection PolicyLifecycle ShellObservation IndicatorTransfer IndicatorAction TargetResolvedInput TargetInputPacing LegacyWmProjection LegacyWmResponseBoundary PixelSilentAdmission; do

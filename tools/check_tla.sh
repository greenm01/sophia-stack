...
for model in VisualRetirement AdmissionRecovery PresentFrameOwnership PresentCopyOwnership SurfaceContentStream GeometryFeedback PolicyConnection PolicyProjection PolicyLifecycle ShellObservation IndicatorTransfer IndicatorAction TargetResolvedInput TargetInputPacing InputAuthorityArbitration LegacyWmProjection LegacyWmResponseBoundary PixelSilentAdmission; do

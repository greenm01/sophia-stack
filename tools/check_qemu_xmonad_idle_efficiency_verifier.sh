...

{
    ...
    echo 'sophia_live_session_control schema=2 status=complete enqueued=259 dispatched=259 delivered=258 stale_retired=1 rejected=0 timed_out=0 unexpected=0 pending=0 peak_depth=1 max_queue_dwell_msec=1 max_ack_msec=2'

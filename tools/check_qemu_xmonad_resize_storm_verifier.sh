...

{
    ...
    echo 'sophia_live_wm_transport schema=2 status=complete peak_depth=1 pending=0 rejected=0 action_coalesced=0 stale_responses=0 max_queue_dwell_msec=1 max_round_trip_msec=10'

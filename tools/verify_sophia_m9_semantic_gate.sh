...
for phase in \
    local-regressions-complete \
    qemu-m7-complete \
    qemu-m8-mix-complete \
    qemu-input-latency-complete; do
...
"$ROOT_DIR/tools/verify_qemu_session_evidence.sh" "$INPUT_LATENCY_EVIDENCE"

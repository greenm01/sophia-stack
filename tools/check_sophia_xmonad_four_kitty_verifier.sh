...
sophia_live_wm_transport schema=2 status=complete peak_depth=2 pending=0 rejected=0 action_coalesced=3 stale_responses=0 max_queue_dwell_msec=12 max_round_trip_msec=180

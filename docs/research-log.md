...
The next buildable critical-path dependency is the metadata-backed shell
rendering model. The protected descriptor feed now exists and is physically
proved; a shell-role display list and descriptor rendering surface do not.

...
use crate::{
    ...
    XAuthorityClientMetadataCandidate, XAuthorityControlAck, XAuthorityControlCommand,
    XAuthorityControlOutcome, XAuthorityDri3FenceImport, XAuthorityDri3PixmapImport,
    XAuthorityInputDeliveryId, XAuthorityInputDeliveryOutcome, XAuthorityInputEvent,
    ...
    XAuthorityRoutedInput, XAuthorityRoutedInputMode, XAuthorityRuntime, XByteOrder, XClientEvent,
...
#[cfg(unix)]
use sophia_protocol::{
    CapacityStallLedger, ClientAdmissionContext, ClientAdmissionId, InputEventKind,
    MetadataDisclosureRule, NamespaceId, Rect, SeatId, Size, SurfaceId, SurfaceOutputReservations,
    TransactionId,
};

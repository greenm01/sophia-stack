...
pub use sophia_engine::{
    ...
    DeterministicFrameClock, DrmKmsMode, EngineError, EngineHeadRegistry, EngineHeadRegistryUpdate,
    EngineLogicalOutputUpdate, ExtendedDesktopTopology, FrameClock, FramePlanRequest,
    FrameScheduleDecision, HeadRenderTarget, HeadlessCompositorBackendAssembly, HeadlessEngine,

...
pub use sophia_engine::{
    ...
    ChromeActionRejectReason, ChromeDescriptorTable, CompositorBackendTickInput,
    DeterministicFrameClock, DrmKmsMode, DrmKmsOutputDescriptor, DrmKmsOutputRegistry,
    DrmKmsOutputRegistryUpdate, EngineError, ExtendedDesktopTopology, FrameClock, FramePlanRequest,
    ...
    OUTPUT_FRAME_SERVICE_CAPACITY, OutputDiscoveryBackend, OutputFrameServiceEffect,
    OutputFrameServiceError, OutputFrameServiceObservation, OutputFrameServiceReducer,
    OutputFrameServiceRequest, OutputNativeFramePhase, OutputPresentationFeedback,
    ...
    ProductionSessionCycleError, ProductionSessionPhase, QueuedInputPoller, RendererSelection,
    RoutedInputCoalescer, RoutedInputFlushReason, RoutedInputQueueAction, RoutedInputRequestError,
    SessionCommand, SessionEvent, SessionLayerSource, SessionTickRequest, SlowClientVisualDecision,
    StaticInputDiscoveryBackend, SurfaceTimeoutPolicy, SurfaceTransactionCommitReadiness,
    SurfaceVisualStateTable, SysfsDrmKmsOutputBackend, WmIpcError, WmRestartReason,
    WmRuntimeAction, WmTransactionUpdate, decide_output_vrr, discover_drm_kms_outputs_from_sysfs,
...
pub use sophia_protocol::{
    ...
    SOPHIA_IPC_MAX_PAYLOAD_LEN, SOPHIA_IPC_VERSION, SanitizedChromeMetadata, SeatId, Size,
    SurfaceConstraints, SurfaceId, SurfacePlacement, SurfaceTransaction,
